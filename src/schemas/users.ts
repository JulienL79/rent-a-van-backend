...
export const users = pgTable("users", {
    ...
    phoneNumber: varchar("phone_number", { length: 20 }).notNull().unique(), // On précise la colonne phone_number qui est un varchar de taille 20 et non nul
    password: varchar("password", { length: 255 }).notNull(), // On précise la colonne password qui est un varchar de taille 255 et non nul
